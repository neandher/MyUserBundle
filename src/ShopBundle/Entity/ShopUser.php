...
use ShopBundle\Model\ShopUserInterface;
use Doctrine\ORM\Mapping as ORM;
use UserBundle\Model\User as BaseUser;
use Symfony\Component\Validator\Constraints as Assert;

/**
 * @ORM\Entity(repositoryClass="ShopBundle\Repository\ShopUserRepository")
...
class ShopUser extends BaseUser implements ShopUserInterface
{
     ...
     * @var Customer
     *
     * @ORM\OneToOne(targetEntity="ShopBundle\Entity\Customer", inversedBy="shopUser", cascade={"persist"})
